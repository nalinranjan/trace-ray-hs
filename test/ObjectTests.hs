...
objectTests :: IO()
objectTests = do hPutStrLn stdout "Object Tests:\n"
                 hPutStrLn stderr "\n\n##########"
...
intersectTriTests = TestList [
  isJust (intersect (Ray {rOrigin = V3 0 0 0, rDirection = V3 12 0 0}) 
  ...
  ~?= False,
  isJust (intersect (Ray {rOrigin = V3 0 0 3000, rDirection = V3 0 0 (-1)}) 
  (Triangle {tV0 = VertexAttrib {
  ...
  vPosition = V3 (-100) (-100) 0, vNormal = V3 0.0 1.0 0.0}, tMat = MaterialDesc {
  mDiffuseColor = RGB {channelRed = 0.52, channelGreen = 0.27, channelBlue = 0.15}, mKr = 0.0, mKt = 0.0, 
  mAlpha = 20.0}, tNormal = V3 0.0 1.0 0.0}))
  ~?= True]
...
intersectSphereTests = TestList [
  isJust (intersect (Ray {rOrigin = V3 0 200 0, rDirection = V3 0 0 0}) 
  ...
  ~?= True,
  isJust (intersect (Ray {rOrigin = V3 1000 200 0, rDirection = V3 0 0 0}) 
...
normalSphereTest = TestList [
  ...
  sRadius = 5030.0, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  mKr = 0.0, mKt = 0.0, mAlpha = 200.0}}) ~?= V3 (-0.4472136) 0.8944272 0,
  normal (V3 (-100) (-200) (-1000)) (Sphere {sCenter = V3 100 50 (-1000), 
  sRadius = 80.0, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  ...
  sRadius = 0.736, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  mKr = 0.0, mKt = 0.0, mAlpha = 200.0}}) ~?= V3 1.0 2.2348695e-4 1.0910846e-5,
  normal (V3 (-2323) (-23234) (-3443)) (Sphere {sCenter = V3 123 12 35453, 
  sRadius = 23233, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  ...
  sRadius = 12.234, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  mKr = 0.0, mKt = 0.0, mAlpha = 200.0}}) ~?= V3 (-1.1988841e-2) (-0.99458957) (-0.10318857),
  normal (V3 1 1 1) (Sphere {sCenter = V3 (-10) 10 (-10), 
  sRadius = 35.0, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
  mKr = 0.0, mKt = 0.0, mAlpha = 200.0}}) ~?= V3 0.6120564 (-0.50077343) 0.6120564,
  normal (V3 10 10 10) (Sphere {sCenter = V3 100 50 (-1000), 
  sRadius = 10.0, sMat = MaterialDesc {mDiffuseColor = RGB {channelRed = 1.0, channelGreen = 0.843, channelBlue = 0.0},
